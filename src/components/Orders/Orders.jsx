...
import { Modal, Button, Tabs as ATabs, Icon } from 'antd';
          ...
          <div className="bg-white">
            <ATabs defaultActiveKey="1">
              ...
              <TabPane
                ...
                key="2"
              >
                <div className="lendOrdersWrappers">
                  <Tabs
              ...
              <TabPane
                ...
                key="3"
              >
                <div className="lendOrdersWrappers borrowOrders" >
                  <ListGroup
                    methods={methods}
                    address={address}
                    contracts={contracts}
                    ...
                    data={{
                      ...
                      data: { myLendOffers: myBorrowOffers, myBorrowOffers }
                    }}
                    web3Utils={web3Utils}
                    loading={loading.orders}
